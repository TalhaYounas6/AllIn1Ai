  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700 pb-17">
      ...
      >
        ...
        <button
            type="button"
            className="flex justify-center  w-full text-white cursor-pointer rounded-lg mt-1 bg-red-500 py-2"
        ...
        <button  disabled={loading} className="w-full  flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 mt-6text-sm rounded-lg cursor-pointer mt-2">
           {
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]">
        <div className="flex items-center gap-3">
          <FileText className="w-5 h-5 test-[#00DA83]" />
