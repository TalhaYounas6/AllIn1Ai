...
const Hero = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-red-500 bg-cover bg-no-repeat min-h-screen">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button
          onClick={() => navigate("/ai")}
          className="bg-black text-white px-10 py-3 rounded-lg hover:scale-102 activate:scale-95 transition cursor-pointer"
        >
          Start creating now
        </button>
      </div>
